...
angular.module ('7minWorkout')
  .controller ('WorkoutController', ['$scope', '$interval', '$location', '$timeout', 'workoutHistoryTracker', 'appEvents',
...
function WorkoutPlan(args) {
  ...
  this.totalWorkoutDuration = function () {
    ...
    total += this.restBetweenExercise * (this.exercises.length - 1);
    return total;
  }
}
...
angular.module ('7minWorkout')
  ...
  function ($scope, $timeout){
    ...
    $scope.$watch ('currentExercise', function (newVal, oldValue) {
      //debugger;
    ...
    $scope.$watch ('currentExerciseDuration', function (newVal) {
      //  debugger;
      if (newVal) {
        if (newVal == Math.floor ($scope.currentExercise.duration / 2) && $scope.currentExercise.details.name !== "rest") {
          $scope.halfWayAudio.play ();
        } else if (newVal == $scope.currentExercise.duration - 3) {
    ...
    $scope.$watch ('workoutPaused', function (newVal, oldVal) {
      //debugger;
      if (newVal) {
